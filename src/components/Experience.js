  ...
  const experiences = [
    {
      ...
      achievements: [
        ...
        "Engineered silver/gold level Databricks tables to enhance data quality and transform raw data into usable formats.",
        "Aligned $30M in AWS, Databricks, and Palantir to their applications, identifying and preventing overspend.",
        "Built micro-frontend components for Deere's largest data platform, so application owners can view their spend.",
        "Implemented AWS cloud services to remotely deploy code, collect logs, house data, configure network, etc.",
        "Worked in an Agile Scrum environment, contributing to sprint planning, stand-ups, and iterative development.",
        "Reviewed production code to ensure quality, resolve issues, and maintain best practices.",
        "Mentored new student team members, offering technical guidance, code reviews, and problem-solving support."
      ]
    },
    {
